...
int main(int argc, char *argv[])
{
  ...
  std::string outputFilename = filepath.substr(found+1)+".lhco";
  WriterBase* writer = manager.InitializeWriter("lhco.gz",outputFilename);
  ...
  while(1)
  {
    ...
    while(1)
    {
      ...
      writer->WriteEvent(myEvent,mySample);
    }
  }
  ...
  rename(outputFilename.c_str(), ("../Output/Skimfiles/"+outputFilename).c_str());
  return 0;
}
